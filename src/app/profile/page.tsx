      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <header className="flex flex-row-reverse items-start justify-between mb-16">
          <div className="text-right">
            <div className="flex flex-row-reverse items-center gap-3 mb-4">
              <span className="px-3 py-1 bg-indigo-500/10 border border-indigo-500/20 rounded-button text-[10px] font-black text-indigo-400 uppercase tracking-widest">Profile Ecosystem v5.0</span>
          ...
          <Link href="/" className="bg-surface-mid p-5 rounded-outer border border-white/10 hover:bg-white/20 transition-all group backdrop-blur-xl hover:scale-110 active:scale-95 shadow-2xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="bg-surface-mid/60 backdrop-blur-3xl border border-white/5 rounded-outer p-8 relative overflow-hidden group shadow-2xl">
               ...
               <div className="flex flex-col items-center relative z-10">
                  <div className="w-40 h-40 rounded-outer bg-surface-low border-4 border-white/5 p-1 mb-6 shadow-2xl relative">
                     {user?.avatar ? (
                       <img 
                         src={user.avatar} 
                         alt={user.name} 
                         referrerPolicy="no-referrer"
                         className="w-full h-full rounded-inner object-cover"
                       />
                     ) : (
                       <div className="w-full h-full rounded-inner bg-gradient-to-br from-indigo-500/20 to-blue-500/20 flex items-center justify-center border border-indigo-500/30">
                          <User className="w-16 h-16 text-indigo-400" size={64} />
                       </div>
                     )}
                     <div className="absolute -bottom-2 -right-2 w-10 h-10 bg-indigo-600 rounded-button border-4 border-surface-mid flex items-center justify-center shadow-xl">
                  ...
                  <div className="grid grid-cols-2 gap-3 w-full mb-3">
                     <div className="bg-surface-low p-4 rounded-inner text-center border border-white/5">
                  ...
                  <div className="w-full bg-surface-low p-5 rounded-inner border border-white/5 mb-4">
            ...
            <div className="bg-gradient-to-br from-emerald-500/10 to-indigo-500/10 border border-white/5 rounded-outer p-8 flex flex-row-reverse items-center justify-between group cursor-pointer hover:bg-white/[0.03] transition-all">
               <div className="text-right">
               ...
               <div className="w-12 h-12 bg-emerald-500/20 rounded-inner flex items-center justify-center border border-emerald-500/40">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {group.sections.map((item) => (
                    <Link
                      ...
                      className="group p-8 bg-surface-mid/30 backdrop-blur-xl border border-white/5 rounded-outer hover:bg-surface-high/50 transition-all hover:scale-[1.02] active:scale-[0.98] shadow-2xl relative overflow-hidden flex flex-row-reverse items-center justify-between"
                    >
                      ...
                      <div className="flex flex-row-reverse items-center gap-6">
                        ...
                        <div className="w-14 h-14 bg-surface-low rounded-inner flex items-center justify-center border border-white/10 group-hover:scale-110 transition-transform shadow-inner group-hover:border-indigo-500/50">
